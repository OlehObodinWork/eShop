...
namespace Catalog.API.Migrations
{
    ...
    [Migration("20250131163105_RenameCatalogFeatureValuesTable")]
    partial class RenameCatalogFeatureValuesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalog.API.Model.CatalogItemVariant", b =>
                {
                    ...
                    b.Property<string>("VarianKeyEnAdjusted")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("eShop.Catalog.API.Model.CatalogFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("eShop.Catalog.API.Model.CatalogFeatureValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("CatalogFeatureId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CatalogFeatureId");

                    b.HasIndex("CatalogItemId");

                    b.ToTable("CatalogFeatureValues");
                });
            ...
            modelBuilder.Entity("CatalogFeatureCatalogItem", b =>
                {
                    b.HasOne("eShop.Catalog.API.Model.CatalogFeature", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eShop.Catalog.API.Model.CatalogFeatureValue", b =>
                {
                    b.HasOne("eShop.Catalog.API.Model.CatalogFeature", "CatalogFeature")
                        .WithMany()
                        .HasForeignKey("CatalogFeatureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
